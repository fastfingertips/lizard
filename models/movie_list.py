...
class WatchList:
    ...
    def get_movies(self) -> list:
        ...
        return _transform_to_ranked_movies(letterboxd_movies)
...
def _transform_to_ranked_movies(letterboxd_movies: dict) -> list:
    """Transform letterboxd movies to ranked list."""
    movies = []
